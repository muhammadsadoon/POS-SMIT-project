...
class StockViewModel {
  ...
  // Add stock (Stock IN)
  static async addStock(productId, quantity, reason, performedBy, notes = '') {
    try {
  ...
  static async removeStock(productId, quantity, reason, performedBy, notes = '') {
    try {
      const product = await Product.findById(productId);
  ...
  static async adjustStock(productId, newQuantity, reason, performedBy, notes = '') {
    try {
      const product = await Product.findById(productId);
